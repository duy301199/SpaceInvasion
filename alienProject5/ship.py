...
class Ship(Sprite):
    exploding_images = [pg.image.load(f'images/explode_{n}.png') for n in range(4)]

    images = [pg.image.load(f'images/killer{n}.png') for n in range(2)]
    ...
    def __init__(self, game):
      ...
      self.image = pg.image.load('images/killer0.png')
    ...
    def set_ufos(self, ufos): self.ufos = ufos
